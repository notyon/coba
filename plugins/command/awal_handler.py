...
async def start_handler(client: Client, msg: types.Message):
    ...
    if not Database().is_member(msg.from_user.id):
        return await msg.reply_photo(
            photo=config.NON_MEMBER_PHOTO,
            caption="❌ ANDA TIDAK TERDAFTAR SEBAGAI MEMBER.\nHUBUNGI ADMIN UNTUK DAFTAR MENJADI MEMBER.\n💰 BIAYA Rp. 2000"
        )
